  ...
  useEffect(() => {
    ...
    const onSubmit = async (data) => {
        const donationRequest = {
            ...
            recipientUpazila:
                upazillas.find((u) => u.id === data.recipientUpazila)?.name || "",
    ...
    return (
        <div className="max-w-5xl mx-auto mt-3 p-8">
            ...
            {currentUser?.status === "blocked" ? (
                <p className="text-center mt-35 bg-red-100 py-10 border border-red-400 rounded-lg text-red-600 font-semibold">
                    ⚠️ You are blocked and cannot create donation requests!
                </p>
            ) : (
                <form
